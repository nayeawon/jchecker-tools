...
/**
 * Runner class for a TBar
 */
public class TbarRunner {
    /**
     * The main method that runs the TBar
     * @param args Command-line arguments containing path, className, and email.
     *             ex) args="/data/jchecker/2023-1-HW2-Eng/00000000/feedback/{date}/autoGeneration 2023-1-HW2-Eng nayeawon@handong.ac.kr"
     */
    ...
    /**
     * Runs program repair process of TBar
     * @param path The path to the student personal directory
     * @param className The name of the class generated by instructor of jChecker
