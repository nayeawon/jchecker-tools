package edu.handong.csee.isel.tbar.context;

import edu.handong.csee.isel.AST.ASTGenerator;
import edu.handong.csee.isel.jdt.tree.ITree;
import edu.handong.csee.isel.tbar.utils.Checker;
import edu.handong.csee.isel.tbar.utils.SetUtils;
    ...
    private static void readFiledsInSuperClass(ITree codeAst, String srcCodePath, Map<String, List<String>> allVarNamesMap, Map<String, String> varTypesMap, List<String> allVarNamesList) {
        ...
        if (superClassName != null) {
            ...
            if (superClassPath != null && new File(superClassPath).exists()) {
                ITree superClassTree = new ASTGenerator().generateTreeForJavaFile(superClassPath, ASTGenerator.TokenType.EXP_JDT);
...
//							break;
    ...
    public static Map<String, String> readPublicStaticFields(File fileName) {
        ...
        ITree tree = new ASTGenerator().generateTreeForJavaFile(fileName, ASTGenerator.TokenType.EXP_JDT);
